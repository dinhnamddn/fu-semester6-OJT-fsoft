                ...
                <div class="col-md-10 pb-5" style="border-left: 1px solid #dcdcdc;border-top: 1px solid #dcdcdc;">
                    ...
                    <div class="card" style="border: none;">
                        ...
                        <div class="card-body px-4 pt-0">
                            <form action="add" method="post" id="edit" onsubmit="myEditProfile(event)">
                                ...
                                <div class="form-group" style="width: 100%;">
                                    ...
                                    <select name="department" class="form-control" id="cars">
                                ...
                                <a href="dashboard">
                                    <button type="submit" class="btn"
                                            style="border: 1px solid #ced4da; background-color: #58bfdd; color: white;"><i
                                            class="fas fa-backward"></i> Back
                                    </button>
                                </a>
